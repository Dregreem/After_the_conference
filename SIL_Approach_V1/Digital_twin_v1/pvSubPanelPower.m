...
% - Passive supplementary harvest layer for off-sun-tracking conditions
    ...
    % Face normal vectors in body frame: 2° outward cant angle (flower model)
    % This creates 4 lateral panels tilted 2° away from vertical, enabling
    % realistic power differentiation during tracking errors and misalignment
    TiltDeg = 2;                      % Outward cant angle [degrees]
    t = sind(TiltDeg);                 % sin(15°) = lateral component
    c = cosd(TiltDeg);                 % cos(15°) = vertical component
    
    % Panel normals: lateral faces tilted 2° outward, creating 3D flower pattern
